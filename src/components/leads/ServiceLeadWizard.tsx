...
export interface ServiceLeadWizardConfig {
  ...
  subtitle:         string;    // service line under "Book a Discovery Call"
              ...
              <div className="space-y-6">
                ...
                {step === 1 && (
                  <div className="space-y-5">
                    <div>
                      <FieldLabel optional>{config.servicesQuestion}</FieldLabel>
                      <p className="text-xs text-slate-500 -mt-1 mb-3">Select all that apply — we'll refine it on the call.</p>
                    ...
                    {config.industries && (
                      <div>
                        <FieldLabel optional>What industry are you in?</FieldLabel>
                        <div className="flex flex-wrap gap-2">
                ...
                {step === 2 && (
                  <div className="space-y-5">
                    <div>
                      <FieldLabel optional>{config.timeframeLabel}</FieldLabel>
                    ...
                    <div>
                      <FieldLabel optional>{config.venueLabel}</FieldLabel>
                    ...
                    {config.sizeLabel && config.sizeOptions && (
                      <div>
                        <FieldLabel optional>{config.sizeLabel}</FieldLabel>
                        <div className="flex flex-wrap gap-2">
                ...
                {step === 3 && (
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Textarea rows={3} value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Goals, must-haves, links…" />
                    </div>
                    {error && <p className="text-sm text-rose-600 bg-rose-50 border border-rose-200 rounded-lg px-3 py-2">{error}</p>}
                    <p className="text-[11px] text-slate-400 text-center">
                      We'll only use your details to follow up about your project.
                    </p>
                  </div>
                )}
                ...
                <div className="flex items-center justify-between gap-3 pt-2">
                  ...
                  {step < TOTAL_STEPS - 1 ? (
                    ...
                    <Button onClick={submit} disabled={!canProceed || submitting} className="bg-rose-500 hover:bg-rose-600 text-white gap-1.5 px-6">
                      {submitting ? <><Loader2 size={16} className="animate-spin" /> Sending…</> : <>Book a Discovery Call <ArrowRight size={16} /></>}
                    </Button>
                  )}
                </div>
              </div>
